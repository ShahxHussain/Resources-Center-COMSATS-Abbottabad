...
int ch,choice,repeat;      //for PROGRAM repitition
int n1,n2;
...
printf(" :) Press (7) to Give 10 PERCENT increment to employee of his/her year of SERVICE.\n");
printf(" :) Press (8) for GRADING SYSTEM.\n");
printf(" :) Press (9) to PRINT SYMBOL in ROWS and COLUMNS.\n");
...

{
	case 6:
		...
		printf("\nYou GOT 15 PERCENT DISCOUNT on %d so YOUR NEW BILL AFTER DISCOUNT IS:Rs:  %d\n\n",bill,bill-(bill/100)*15);
		break;
	}
